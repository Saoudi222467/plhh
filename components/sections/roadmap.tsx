...
import { Coins, Globe2, Users, Rocket, Building2, Gem, Boxes, Network, GamepadIcon, Share2, Shield, Trophy } from 'lucide-react'
...
export function RoadmapSection() {
  return (
    <section className="relative py-20" id="roadmap">
      {/* Background effects */}
      ...
      <Container className="flex flex-col items-center">
        <Reveal>
          <div className="mb-16 text-center">
            <h2 className="mb-4 bg-gradient-to-r from-amber-200 via-yellow-400 to-amber-200 bg-clip-text font-montserrat text-3xl font-bold tracking-tight text-transparent sm:text-4xl">
              Journey to Digital Harmony
            </h2>
            <p className="mx-auto max-w-2xl text-neutral-400">
              Our comprehensive roadmap to revolutionize the digital landscape through
              blockchain technology and community-driven innovation
            </p>
          </div>
        </Reveal>
        ...
        <div className="relative mx-auto max-w-5xl">
          {/* Center line */}
          <div className="mt-10 absolute left-1/2 top-0 h-full w-px -translate-x-1/2 bg-gradient-to-b from-yellow-500/50 via-yellow-500/10 to-transparent" />
              ...
              <div className="relative mb-24 last:mb-0 mt-2">
                ...
                <div className="mb-20 flex justify-center">
                  <motion.div
                    ...
                    className="relative inline-flex items-center gap-2 rounded-full border border-yellow-500/20 bg-black/40 px-4 py-2 backdrop-blur-sm"
                  >
                    <phase.icon className="h-5 w-5 text-yellow-500" />
                    <span className="font-montserrat text-lg font-semibold text-yellow-500">
                ...
                <div className="grid gap-8 md:grid-cols-2">
                  ...
                  <motion.div
                    ...
                    className="rounded-lg border border-yellow-500/10 bg-black/40 p-6 backdrop-blur-sm h-full"
                  >
                    <div className="mb-4">
                      <div className="mb-2 font-mono text-sm text-yellow-500">
                        {phase.timeline}
                      </div>
                  ...
                  <div className="space-y-4 h-full flex flex-col justify-between">
                    {phase.items.map((item, itemIndex) => (
                      <motion.div
                        key={itemIndex}
                        whileHover={{ scale: 1.02 }}
                        className="rounded-lg border border-yellow-500/10 bg-black/40 p-4 backdrop-blur-sm flex-1"
                      >
                        <div className="mb-2 flex items-center gap-2">
                          <item.icon className="h-5 w-5 text-yellow-500" />
                          <h4 className="font-montserrat text-sm font-semibold text-yellow-500">
                            {item.title}
                          </h4>
                        </div>
