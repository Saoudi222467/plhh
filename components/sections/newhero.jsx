        ...
        <div className="flex min-h-screen items-center justify-center sm:justify-start">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-2 md:order-1">
              ...
              >
                <h1 className="bg-gradient-to-r from-amber-200 via-yellow-400 to-amber-200 bg-clip-text font-montserrat text-5xl font-bold tracking-tight text-transparent text-center sm:text-left">
                  Peace Love & Harmony
                </h1>
                <p className="max-w-xl text-lg text-neutral-300 md:text-xl">
                  For more Humanity - Revolutionizing the future through
